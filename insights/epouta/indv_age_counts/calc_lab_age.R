...
pheno_data <- tibble::as_tibble(data.table::fread(paste0(pheno_dir, "minimal_phenotype_2023-08-14.csv")))
...
finregids <- tibble::as_tibble(data.table::fread(paste0(res_dir, "kanta_lab_", date, "_finregid_counts.tsv")))
...
data.table::fwrite(tib, file=paste0(res_dir, "kanta_lab_", date, "_age_2020_table.tsv"), sep="\t")