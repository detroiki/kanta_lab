...
int main(int argc, char *argv[]) {
    ...
    // Fills the map with the individuals IDs for which there is data for each OMOP concept ID
    // The map is of form: OMOP_ID -> {FINREGISTRYID1, FINREGISTRYID2, ...}
    ...
    write_top_lab_data(file_path, res_path, keep_omop_ids);
}
